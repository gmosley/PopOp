...
def export_results():
    ...
    with open('results.csv', 'wb') as csvfile:
        ...
        csvwriter.writerow(['id', 'set_id', 'worker_id', 'first', 'second', 'third', 'first_addr', 'second_addr', 'third_addr'])
        for row in results:
            ...
            csvwriter.writerow([row.id, row.set_id, row.worker_id, first[0], second[0], third[0], first[1], second[1], third[1]])
